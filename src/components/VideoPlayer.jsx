...
export default function VideoPlayer({ videoDetails, onClose }) {
  ...
  useEffect(() => {
    ...
    player.ready(() => {
      // Stop previous video and load new source
      player.pause();
      player.src({
        src: videoDetails.hls_stream,
        type: "application/x-mpegURL",
  ...
  return (
    <div className="relative w-full max-w-5xl mx-auto aspect-video bg-black rounded overflow-hidden">
      {/* Overlay bar */}
